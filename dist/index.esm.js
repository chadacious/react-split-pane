  ...
  (function(_React$PureComponent) {
    ...
    function Pane() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(Pane).apply(this, arguments)
      );
    }
...
var Resizer =
  ...
  (function(_React$Component) {
    ...
    function Resizer() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(Resizer).apply(this, arguments)
      );
    }
  ...
  (function(_React$Component) {
    ...
    function SplitPane(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(SplitPane).call(this, props)
      );
      _this.onMouseDown = _this.onMouseDown.bind(_assertThisInitialized(_this));
      _this.onTouchStart = _this.onTouchStart.bind(
        ...
        },
        {
          ...
          value: function render() {
            ...
            var resizerClassNamesIncludingDefault = resizerClassName
              ? ''
                  .concat(resizerClassName, ' ')
                  .concat(RESIZER_DEFAULT_CLASSNAME)
              : resizerClassName;
